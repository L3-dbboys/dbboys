...
<table>
    <tr>
        ...
        <th align="left">过滤字段</th>  <!-- 右对齐-->
        <th align="left">索引字段</th>  <!-- 右对齐-->
        <th align="left">执行耗时</th>  <!-- 右对齐-->
    </tr>
    <tr>
        <td>1</td>
        <td>select * from t_user where c_name='天津南' and c_sex='男' and c_cardno='430524199008129900';</td>
        <td>100000</td>
        <td>c_name and c_sex and c_cardno</td>
      	<td>无</td>
      	<td>0.022 sec</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>5</td>
        <td>select count(*) from t_user where c_name='天津南' or c_sex='男' or c_cardno='430524199008129900';</td>
        <td>100000</td>
        <td>c_name or c_sex or c_cardno</td>
      	<td>无</td>
      	<td>0.027 sec</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>100000</td>
        <td>c_name or c_sex or c_cardno</td>
      	<td>c_cardno,c_name,c_sex</td>
      	<td>0.028 sec</td>
    </tr>
    <tr>
        <td>10</td>
        <td>select count(*) from t_user where c_name='天津南' or c_cardno='430524199008129900';</td>
        <td>100000</td>
        <td>c_name  or c_cardno</td>
      	<td>无</td>
      	<td>0.027 sec</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>100000</td>
        <td>c_name or c_cardno</td>
      	<td>idx1(c_cardno),idx2(c_name)</td>
      	<td>0.005 sec</td>
    </tr>
</table>
