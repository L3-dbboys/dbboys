...
final class InstanceTabLoaders {
    ...
    record SpaceTabData(List<SpaceUsage> dbspaceList,
                        List<SpaceUsage> chunkChartList,
                        List<SpaceUsage> databaseChartList,
                        List<SpaceUsage> tabChartList) {
    }

    static SpaceTabData loadSpaceTabData(Logger log, Connect connect, AdminService adminService) {
        try {
            List<List<SpaceUsage>> dataList = adminService.getStorageSpaceUsage(connect);
